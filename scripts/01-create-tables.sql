...
-- Salt: 16 random bytes (hex representation)
INSERT INTO users (email, salt, md5_hash, role, full_name, is_active) VALUES
('test@example.com', UNHEX('1234567890ABCDEF1234567890ABCDEF'), MD5(CONCAT(UNHEX('1234567890ABCDEF1234567890ABCDEF'), 'password123')), 'STUDENT', 'Test User', TRUE),
('admin@example.com', UNHEX('FEDCBA0987654321FEDCBA0987654321'), MD5(CONCAT(UNHEX('FEDCBA0987654321FEDCBA0987654321'), 'admin123')), 'ADMIN', 'Admin User', TRUE),
('trainer@example.com', UNHEX('ABCDEF1234567890ABCDEF1234567890'), MD5(CONCAT(UNHEX('ABCDEF1234567890ABCDEF1234567890'), 'trainer123')), 'TRAINER', 'Trainer User', TRUE);
